...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE IF NOT EXISTS "forms_blocks_hidden" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  ALTER TABLE "home_blocks_service_section" ADD COLUMN "form_id" integer;
  DO $$ BEGIN
  ...
  CREATE INDEX IF NOT EXISTS "forms_blocks_hidden_order_idx" ON "forms_blocks_hidden" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "forms_blocks_hidden_parent_id_idx" ON "forms_blocks_hidden" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "forms_blocks_hidden_path_idx" ON "forms_blocks_hidden" USING btree ("_path");
  ...
  DO $$ BEGIN
   ALTER TABLE "home_blocks_service_section" ADD CONSTRAINT "home_blocks_service_section_form_id_forms_id_fk" FOREIGN KEY ("form_id") REFERENCES "public"."forms"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "home_blocks_service_section_form_idx" ON "home_blocks_service_section" USING btree ("form_id");`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "home_blocks_service_section" DROP CONSTRAINT "home_blocks_service_section_form_id_forms_id_fk";
  ...
  DROP INDEX IF EXISTS "home_blocks_service_section_form_idx";
  ...
  ALTER TABLE "home_blocks_service_section" DROP COLUMN IF EXISTS "form_id";
